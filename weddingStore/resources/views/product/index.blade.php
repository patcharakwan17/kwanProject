        ...
        <center>
            ...
            @foreach($packages as $package)
                ...
                <div class="col-sm-4">
                        ...
                        <div class="colm" style="background-color: #df4118;">
                            <div class="price" style="background-color: #df4118;">  {{  number_format($package->packPrice,2) }} Baht</div>
                            
                            <img src="{{ asset('images/'.$package->packImg) }}">
                            
                            <br>
                            <h4 class="headerPack">{{ $package->packName }}</h4>
                            <p>
                                <center style="margin: 0px 15px 0px 15px;">{{ $package->packDetail }}</center>
                            </p>
                        </div>
                        <div class=""><br>
                        <!--<a class="btnAdcart" id="adcartone" href="{{ url('/product/adcart/'.$package->packId) }}">
                            Add to Cart!
                        </a>-->
                        <a class="btnAdcart" id="adcartone" href="{{ url('/product/adcart/') }}">
                            Add to Cart!
                        </a>
                ...
                @elseif($package->packId === 2)
                    <div class="col-sm-4">
                        
                        <div class="colm" style="background-color: #202724;">
                            <div class="price" style="background-color: #202724;">  {{  number_format($package->packPrice,2) }} Baht</div>
                        ...
                        <div class=""><br>
                        <a class="btnAdcart" id="adcarttwo" href="{{ url('/product/'.$package->packId.'/adcart/') }}">
                            Add to Cart!
                        </a>
                        </div>
                ...
                @elseif($package->packId === 3)
                    <div class="col-sm-4">
                        
                        <div class="colm" style="background-color: #60be98;">
                            <div class="price" style="background-color: #60be98;">  {{  number_format($package->packPrice,2) }} Baht</div>
                        ...
                        <div class=""><br>
                        <a class="btnAdcart" id="adcartthree" href="{{ url('/product/'.$package->packId.'/adcart/') }}">
                            Add to Cart!
                        </a>
                        </div>
